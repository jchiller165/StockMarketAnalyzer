package com.analyzer.application.output.quote;
...
import com.analyzer.application.alpha.BatchStockQuotes;
import com.analyzer.application.output.AlphaVantageException;
import com.analyzer.application.output.JsonParser;
import com.analyzer.application.output.quote.data.StockQuote;
