...
import com.analyzer.application.output.timeseries.DailyAdjusted;
import com.analyzer.application.output.timeseries.IntraDay;
import com.analyzer.application.output.timeseries.Monthly;
import com.analyzer.application.output.timeseries.MonthlyAdjusted;
import com.analyzer.application.output.timeseries.Weekly;
import com.analyzer.application.output.timeseries.WeeklyAdjusted;
